...
Define governing principles and development guidelines:
...
2. Create the Spec
Describe what you want to build and why, not the tech stack:
...
specifyplus check
Slash Commands
After running specifyplus init, your AI coding agent supports these commands.
